...
tf.app.flags.DEFINE_integer("eval_every", 20000, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.")
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with open(os.path.join(FLAGS.train_dir, "flags.json"), 'w', encoding='utf-8') as fout:
